export default [
	...
	{name:'上海', geoCoord:[122.48, 32.22]}
	{name:'上海', geoCoord:[123.48, 33.22]},
	{name:'上海', geoCoord:[125.48, 35.22]},
	{name:'上海', geoCoord:[122.48, 33.22]},
	{name:'上海', geoCoord:[127.48, 37.22]},
	{name:'上海', geoCoord:[126.48, 32.22]},
	{name:'上海', geoCoord:[122.48, 33.22]},
	{name:'上海', geoCoord:[125.48, 32.22]},
	{name:'上海', geoCoord:[123.48, 34.22]},
	{name:'上海', geoCoord:[124.48, 35.22]},
	{name:'上海', geoCoord:[125.48, 33.22]},
	{name:'上海', geoCoord:[123.48, 34.22]},
	{name:'上海', geoCoord:[125.48, 32.22]},
	...
	{name:'广州', geoCoord:[115.23, 21.16]},
	{name:'广州', geoCoord:[118.23, 22.16]},
	{name:'广州', geoCoord:[116.23, 24.16]},
	{name:'广州', geoCoord:[117.23, 25.16]},
	{name:'广州', geoCoord:[114.23, 22.16]},
	{name:'广州', geoCoord:[118.23, 25.14]},
	{name:'广州', geoCoord:[117.22, 24.16]},
	{name:'广州', geoCoord:[119.23, 25.16]},
	{name:'广州', geoCoord:[118.23, 22.16]},
	{name:'广州', geoCoord:[116.23, 25.16]},
	{name:'广州', geoCoord:[117.23, 26.16]},
	{name:'广州', geoCoord:[115.23, 22.16]},
	{name:'广州', geoCoord:[114.23, 21.16]},
	{name:'广州', geoCoord:[115.23, 22.16]},
	{name:'广州', geoCoord:[117.23, 27.16]},
	{name:'广州', geoCoord:[110.23, 20.16]},
	{name:'广州', geoCoord:[109.23, 26.16]},
	{name:'广州', geoCoord:[107.23, 27.16]},
	...
	{name:'深圳', geoCoord:[115.07, 23.62]},
	{name:'深圳', geoCoord:[117.07, 28.62]},
	{name:'深圳', geoCoord:[116.07, 25.62]},
	{name:'深圳', geoCoord:[115.07, 24.62]},
	{name:'深圳', geoCoord:[116.07, 27.62]},
	{name:'深圳', geoCoord:[113.07, 21.62]},
	{name:'深圳', geoCoord:[117.07, 25.62]},
	{name:'深圳', geoCoord:[115.07, 27.62]},
	{name:'深圳', geoCoord:[115.07, 23.62]},
	{name:'深圳', geoCoord:[114.07, 22.62]},
    {name:'珠海', geoCoord:[116.52, 25.3]},
	...
	{name:'苏州', geoCoord:[121.62, 32.32]},
	{name:'苏州', geoCoord:[123.62, 30.32]},
	{name:'苏州', geoCoord:[124.62, 32.32]},
	{name:'苏州', geoCoord:[126.62, 36.32]},
	{name:'苏州', geoCoord:[125.62, 35.32]},
	{name:'苏州', geoCoord:[127.62, 32.32]},
	{name:'苏州', geoCoord:[124.62, 34.32]},
	{name:'苏州', geoCoord:[123.62, 33.32]},
	{name:'苏州', geoCoord:[127.62, 37.32]},
	{name:'苏州', geoCoord:[128.62, 32.32]},
	{name:'苏州', geoCoord:[122.62, 32.32]},
	{name:'苏州', geoCoord:[127.62, 37.32]},
	{name:'苏州', geoCoord:[126.62, 36.32]},
	{name:'苏州', geoCoord:[120.62, 33.32]},
	...
	{name:'成都', geoCoord:[105.06, 31.67]},
	{name:'成都', geoCoord:[103.06, 33.67]},
	{name:'成都', geoCoord:[106.06, 35.67]},
	{name:'成都', geoCoord:[105.06, 33.67]},
	{name:'成都', geoCoord:[103.06, 31.67]},
	{name:'成都', geoCoord:[106.06, 36.67]},
    ...
    {name:'西安', geoCoord:[109.41, 34.27]}, 
    {name:'西安', geoCoord:[110.95, 35.27]}, 
    {name:'西安', geoCoord:[105.95, 39.27]},  
    {name:'西安', geoCoord:[101.95, 38.27]},   
    {name:'西安', geoCoord:[102.41, 34.27]}, 
    {name:'西安', geoCoord:[107.95, 35.27]}, 
    {name:'西安', geoCoord:[108.95, 39.27]},  
    {name:'西安', geoCoord:[108.95, 39.27]}, 
    {name:'西安', geoCoord:[108.25, 32.27]}, 
    {name:'西安', geoCoord:[108.95, 32.27]}, 
    {name:'西安', geoCoord:[107.95, 33.97]}, 
    {name:'西安', geoCoord:[108.15, 31.27]}, 
    {name:'西安', geoCoord:[109.15, 32.27]}, 
    {name:'西安', geoCoord:[109.15, 33.27]},
    {name:'西安', geoCoord:[107.15, 32.27]}, 
    {name:'西安', geoCoord:[109.15, 34.27]}, 
    {name:'西安', geoCoord:[109.15, 36.27]},
    {name:'西安', geoCoord:[109.15, 35.27]},
    {name:'西安', geoCoord:[109.15, 33.27]}, 
    {name:'西安', geoCoord:[109.15, 35.27]},   	
    {name:'西安', geoCoord:[108.25, 34.07]}, 
    {name:'西安', geoCoord:[107.15, 36.27]},
    {name:'西安', geoCoord:[110.15, 37.27]}, 
    {name:'西安', geoCoord:[108.15, 32.27]}, 
    {name:'西安', geoCoord:[110.15, 34.27]},
    {name:'西安', geoCoord:[111.15, 33.27]},  	
	...
	{name:'南京', geoCoord:[119.78, 31.04]},
	{name:'南京', geoCoord:[121.78, 33.04]},
	{name:'南京', geoCoord:[118.78, 34.14]},
	{name:'南京', geoCoord:[117.78, 35.04]},
	{name:'南京', geoCoord:[119.78, 31.04]},
	{name:'南京', geoCoord:[116.78, 30.04]},
	{name:'南京', geoCoord:[117.78, 33.04]},
	{name:'南京', geoCoord:[113.78, 34.04]},
	{name:'南京', geoCoord:[116.78, 36.04]},
	{name:'南京', geoCoord:[117.78, 33.04]},
	{name:'南京', geoCoord:[116.78, 36.04]},
	...
	{name:'北京', geoCoord:[117.46, 39.92]},
	{name:'北京', geoCoord:[115.46, 38.92]},
	{name:'北京', geoCoord:[118.46, 34.92]},
	{name:'北京', geoCoord:[112.46, 34.92]},
	{name:'北京', geoCoord:[114.46, 37.92]},
	{name:'北京', geoCoord:[113.46, 33.92]},
	{name:'北京', geoCoord:[115.46, 35.92]},
	{name:'北京', geoCoord:[116.46, 36.92]},
	{name:'北京', geoCoord:[114.46, 33.92]},
	{name:'北京', geoCoord:[112.46, 35.92]},
	{name:'北京', geoCoord:[112.46, 32.92]},
	{name:'北京', geoCoord:[115.46, 35.92]},
	{name:'北京', geoCoord:[112.46, 38.92]},
	{name:'北京', geoCoord:[116.46, 36.92]},
	{name:'北京', geoCoord:[114.46, 34.92]},
	{name:'北京', geoCoord:[113.46, 34.92]},
	{name:'北京', geoCoord:[115.46, 34.92]},
	{name:'北京', geoCoord:[117.46, 39.92]},
	{name:'北京', geoCoord:[118.46, 39.92]},
	{name:'北京', geoCoord:[116.46, 38.92]},
	{name:'北京', geoCoord:[115.46, 37.92]},
	{name:'北京', geoCoord:[117.46, 39.92]},
	...
	{name:'乌鲁木齐', geoCoord:[86.62, 43.77]},
	{name:'乌鲁木齐', geoCoord:[88.61, 41.77]},
	{name:'乌鲁木齐', geoCoord:[89.61, 43.77]},
	{name:'乌鲁木齐', geoCoord:[85.61, 41.77]},
	{name:'乌鲁木齐', geoCoord:[86.61, 41.77]},
	{name:'乌鲁木齐', geoCoord:[87.61, 42.77]},
	{name:'乌鲁木齐', geoCoord:[82.61, 43.77]},
	{name:'乌鲁木齐', geoCoord:[84.61, 40.77]},
	{name:'乌鲁木齐', geoCoord:[88.61, 41.77]},
    {name:'枣庄', geoCoord:[117.57, 34.86]},
    {name:'杭州', geoCoord:[120.19, 30.26]},
	{name:'杭州', geoCoord:[122.19, 35.26]},
	{name:'杭州', geoCoord:[123.19, 34.26]},
	{name:'杭州', geoCoord:[121.19, 33.26]},
	{name:'杭州', geoCoord:[116.19, 33.26]},
	{name:'杭州', geoCoord:[114.19, 35.26]},
	{name:'杭州', geoCoord:[125.19, 32.26]}, 
	{name:'杭州', geoCoord:[123.19, 31.26]},
	{name:'杭州', geoCoord:[125.19, 32.26]},
	{name:'杭州', geoCoord:[126.19, 34.26]},
	{name:'杭州', geoCoord:[128.19, 32.26]},
	{name:'杭州', geoCoord:[121.19, 30.26]},
	{name:'杭州', geoCoord:[120.19, 34.26]},
	{name:'杭州', geoCoord:[124.19, 31.26]},
	{name:'杭州', geoCoord:[128.19, 32.26]},
	{name:'杭州', geoCoord:[127.19, 33.26]},
	{name:'杭州', geoCoord:[124.19, 35.26]},
	{name:'杭州', geoCoord:[128.19, 32.26]},
	{name:'杭州', geoCoord:[126.19, 32.26]},
